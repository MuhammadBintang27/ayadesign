                ...
                <div className="container mx-auto px-5 py-24 flex flex-wrap flex-col md:flex-row md:items-center">
                    ...
                    <div className="lg:w-1/3 md:w-1/3 w-full px-4">
                        ...
                        <div className="lg:w-1/3 md:w-1/3 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <a href="https://www.instagram.com/ayadsign?igsh=MWVibXhjanltcTc2aQ==" className="text-gray-600 hover:text-gray-800 flex items-center justify-center md:justify-start">
                                ...
                                <li>
                                    <a href="https://www.tiktok.com" className="text-gray-600 hover:text-gray-800 flex items-center justify-center md:justify-start">
                        ...
                        <div className="lg:w-1/3 md:w-1/3 w-full px-4">
                            <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">@ayadesign</h2>
